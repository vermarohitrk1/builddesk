...
<div class="mb-4">
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('reports.expense.pdf', request()->query()) }}" class="btn btn-outline-danger">
                <i class="fas fa-file-pdf me-1"></i> Export PDF
            </a>
            <a href="{{ route('reports.expense.excel', request()->query()) }}" class="btn btn-outline-success">
...
<div class="card mb-4 border shadow-sm">
    <div class="card-body">
        <form method="GET" action="{{ route('reports.expense') }}" class="row g-3">
            <div class="col-md-2">
            ...
            <div class="col-md-3">
                <label class="form-label font-weight-bold small text-muted">Category</label>
            ...
            <div class="col-md-2">
                <label class="form-label font-weight-bold small text-muted">Supplier</label>
            ...
            <div class="col-md-1">
                <label class="form-label font-weight-bold small text-muted">Method</label>
            ...
            <div class="col-md-2 d-flex align-items-end gap-2">
                ...
                <a href="{{ route('reports.expense') }}" class="btn btn-outline-secondary">Reset</a>
            </div>
        </form>
    </div>
</div>
...
<div class="row mb-4">
    <div class="col-md-6 col-lg-3">
        <div class="card border shadow-sm h-100">
            <div class="card-body">
                <div class="text-muted small text-uppercase">Total Expenses</div>
                <h3 class="mb-0 text-danger fw-bold mt-2">₹ {{ number_format($totalExpense, 2) }}</h3>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-lg-3">
        <div class="card border shadow-sm h-100">
            <div class="card-body">
                ...
                <h3 class="mb-0 text-dark fw-bold mt-2">{{ $expenseCount }}</h3>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-striped align-middle mb-0">
                <thead class="table-light">
                    <tr>
                        <th class="ps-4 py-3">Expense Date</th>
                ...
                <tbody>
                    @forelse($reports as $row)
                        <tr>
                            <td class="ps-4">{{ $row['expense_date'] }}</td>
                            ...
                            <td>
                                @php
                                    ...
                                    $class = $badges[$row['payment_method']] ?? 'bg-light text-dark';
                                @endphp
                                <span class="badge {{ $class }}">{{ $row['payment_method'] }}</span>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center py-4 text-muted">No expenses recorded for this period.</td>
                        </tr>
                    @endforelse
                </tbody>
                @if(count($reports) > 0)
                <tfoot>
                    <tr class="table-light fw-bold border-top border-dark">
                        ...
                        <td></td>
                        <td></td>
                        <td class="text-end pe-4 fw-bold">₹ {{ number_format($totalExpense, 2) }}</td>
                    </tr>
                </tfoot>
                @endif
            </table>
